//-----------------------------------------------------------------------
// <copyright file="Program.cs" company="VLS">
...
namespace GoofyCoin2015
{
    ...
    /// <summary>
    /// The console application program class
    /// </summary>
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Tests.ReceivingAndMakingManyTransfers_ShouldHaveValidTransferChain();
            Tests.ChengeTransfer_ShouldNotAffectTransferChain();
            Tests.DoubleSpendAttack_ShouldNotHaveValidTransferChain();
