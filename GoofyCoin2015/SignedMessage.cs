...
namespace GoofyCoin2015
{
    ...
    public class SignedMessage
    {
        ...
        /// <summary>
        /// Is signature of the transfer?
        /// </summary>
        /// <param name="transfer">transfer instance</param>
        /// <returns>return true if its the signature of the transfer</returns>
        public virtual bool IsValidSignedTransfer(TransferList transfer)
        {
            return this.IsValidSignedMsg(Global.SerializeObject(transfer), this.publicKey);
        }
